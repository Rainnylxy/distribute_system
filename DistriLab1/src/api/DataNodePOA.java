 ...
 implements api.DataNodeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("returnStatus", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // api/DataNode/append
       {
         ...
         int fileBlockId = in.read_long ();
         this.append (block_id, bytes, filename, fileBlockId);
         out = $rh.createReply();
         break;
       }
       ...
       case 3:  // api/DataNode/returnStatus
       {
         String recv = in.read_string ();
         String $result = null;
         $result = this.returnStatus (recv);
         out = $rh.createReply();
