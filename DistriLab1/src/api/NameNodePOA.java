 ...
 implements api.NameNodeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("allocateDN", new java.lang.Integer (2));
  }
  ...
  //TODO: complete the interface design
       case 0:  // api/NameNode/open
       {
         ...
         api.FileMetaData $result = null;
         $result = this.open (filepath, mode);
         out = $rh.createReply();
         api.FileMetaDataHelper.write (out, $result);
         break;
       }
  ...
  //allocateBlock(string filepath,int filesize);
       ...
       case 2:  // api/NameNode/allocateDN
       {
         String filepath = in.read_string ();
         int filesize = in.read_long ();
         String $result[] = null;
         $result = this.allocateDN (filepath, filesize);
         out = $rh.createReply();
         api.dataBlockInfoHelper.write (out, $result);
         break;
       }
