...
public class _DataNodeStub extends org.omg.CORBA.portable.ObjectImpl implements api.DataNode
{
  ...
  public void append (int block_id, byte[] bytes, String filename, int fileBlockId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                append (block_id, bytes, filename, fileBlockId        );
            } finally {
                _releaseReply ($in);
            }
  } // append
  ...
  public String returnStatus (String recv)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("returnStatus", true);
                $out.write_string (recv);
                $in = _invoke ($out);
